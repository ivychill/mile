...
for epoch in tqdm(range(n_epoch)):
    ...
    X_test, Y_test = sample_correlated_gaussian(rho, dim, batch_size=1024, cubic=None)
    # Y_test = trans_func(Y_test, 'cubic')
